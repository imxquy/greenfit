                                ...
                                <div className="font-normal text-gray-500/70">
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        <select onChange={e => updateCartItem(product._id, Number(e.target.value))} value={product.quantity} className='outline-none'>
                                            {Array(Math.max(9, product.quantity)).fill('').map((_, i) => (
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    <p className="flex justify-between">
                        <span>Price</span><span>{getCartAmount()}{currency}</span>
                    </p>
                    <p className="flex justify-between">
                        <span>Shipping Fee</span><span className="text-green-600">Free</span>
                    </p>
                    <p className="flex justify-between">
                        <span>Tax (2%)</span><span>{(getCartAmount() * 0.02).toFixed(2)}{currency}</span>
                    </p>
                    <p className="flex justify-between text-lg font-medium mt-3">
                        <span>Total Amount:</span><span>{(getCartAmount() * 1.02).toFixed(2)}{currency}</span>
                    </p>
                </div>
