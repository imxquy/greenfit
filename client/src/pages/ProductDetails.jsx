            ...
            <div className="flex flex-col md:flex-row gap-16 mt-4">
                <div className="flex gap-3">
                    <div className="flex flex-col gap-3">
                        {product.images.map((img, i) => (
                            <div key={i} onClick={() => setThumbnail(img)} className="border max-w-24 border-gray-500/30 rounded overflow-hidden cursor-pointer">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <button onClick={() => setBuyNowProduct(product)} className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-primary-dull transition">
                            Buy now
                        </button>
                    </div>
                </div>
