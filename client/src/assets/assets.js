...
import GreenFit_Logo from "./GreenFit_Logo.svg";
import herbal_tea_image from "./herbal_tea_image.png";
import whey_image from "./whey_image.png";
import preworkout_image from "./preworkout_image.png";
import vitamins_image from "./vitamins_image.png";
...
export const categories = [
  ...
  },
  {
    text: "Herbal Teas",
    path: "HerbalTeas",
    image: herbal_tea_image, 
    bgColor: "#E6F3E6",
  },
  {
    text: "Instant Health Foods",
    path: "Instant",
    image: maggi_image,
    bgColor: "#E1F5EC",
  },
  {
    text: "Dairy & Plant Products",
    path: "Dairy",
    image: dairy_product_image,
    bgColor: "#FEE6CD",
  },
  {
    text: "Bakery & & Whole Grains",
    path: "Bakery",
    image: bakery_image,
    bgColor: "#E0F6FE",
  },
  ...
  },
  {
    text: "Pre-workout",
    path: "Preworkout",
    image: preworkout_image, 
    bgColor: "#FFE3F1",
  },
  {
    text: "Vitamins & Minerals",
    path: "Vitamins",
    image: vitamins_image, 
    bgColor: "#F9F8E9",
  },
];
